...
const gifts = {
    'console.log guru': {
        ...
        superpowers: {
            ...
            create: { value: '+90', stars: 5 },
            love: { value: '+60', stars: 3 },
            dream: { value: '+75', stars: 4 }
        }
    },
    'hydration bot': {
        category: 'for health',
        ...
        superpowers: {
            live: { value: '+85', stars: 5 },
            create: { value: '+300', stars: 3 },
            love: { value: '+75', stars: 4 },
            dream: { value: '+70', stars: 3 }
        }
    },
    'merge master': {
        category: 'for work',
        ...
        superpowers: {
            live: { value: '+70', stars: 3 },
            create: { value: '+95', stars: 5 },
            love: { value: '+200', stars: 3 },
            dream: { value: '+80', stars: 4 }
        }
    },
    'spontaneous coding philosopher': {
        ...
        superpowers: {
            live: { value: '+90', stars: 5 },
            create: { value: '+70', stars: 3 },
            love: { value: '+85', stars: 4 },
            dream: { value: '+100', stars: 4 }
        }
    },
    'step master': {
        category: 'for health',
        ...
        superpowers: {
            live: { value: '+88', stars: 4 },
            create: { value: '+60', stars: 3 },
            love: { value: '+72', stars: 3 },
            dream: { value: '+75', stars: 4 }
        }
    },
    'bug magnet': {
        ...
        superpowers: {
            live: { value: '+75', stars: 4 },
            create: { value: '+85', stars: 4 },
            love: { value: '+70', stars: 3 },
            dream: { value: '+80', stars: 4 }
        }
    },
    'shortcut cheater': {
        ...
        superpowers: {
            live: { value: '+80', stars: 4 },
            create: { value: '+92', stars: 5 },
            love: { value: '+65', stars: 3 },
            dream: { value: '+85', stars: 4 }
        }
    },
    'posture levitation': {
        category: 'for health',
        ...
        superpowers: {
            live: { value: '+82', stars: 4 },
            create: { value: '+68', stars: 3 },
            love: { value: '+75', stars: 4 },
            dream: { value: '+70', stars: 3 }
        }
    },
    'bug acceptance guru': {
        ...
        superpowers: {
            live: { value: '+85', stars: 4 },
            create: { value: '+75', stars: 4 },
            love: { value: '+88', stars: 4 },
            dream: { value: '+90', stars: 5 }
        }
    },
    'snack resister': {
        category: 'for health',
        ...
        superpowers: {
            live: { value: '+80', stars: 4 },
            create: { value: '+65', stars: 3 },
            love: { value: '+70', stars: 3 },
            dream: { value: '+78', stars: 4 }
        }
    },
    'error laugher': {
        category: 'for harmony',
        ...
        superpowers: {
            live: { value: '+88', stars: 4 },
            create: { value: '+80', stars: 4 },
            love: { value: '+85', stars: 4 },
            dream: { value: '+92', stars: 5 }
        }
    },
    'joy charger': {
        category: 'for harmony',
        ...
        superpowers: {
            live: { value: '+92', stars: 5 },
            create: { value: '+85', stars: 4 },
            love: { value: '+90', stars: 5 },
            dream: { value: '+88', stars: 4 }
        }
    }
};
